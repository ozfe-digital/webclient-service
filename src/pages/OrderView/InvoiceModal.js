            ...
            <div className="p-4">
              <Row className="mb-4">
                <Col md={4}>
                  ...
                  <div>{this.props.customer||''}</div>
                  <div>{this.props.customer_address||''}</div>
                  <div>{this.props.customer_email||''}</div>
                  <div>{this.props.contact_number||''}</div>
                </Col>
                <Col md={4}>
              ...
              <Table className="mb-0">
                ...
                {this.props.orderDetails.map((eachRow, index) => {
